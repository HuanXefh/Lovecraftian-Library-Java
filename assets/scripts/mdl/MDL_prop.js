...
*/
    ...
    /**
     * Returns reload fraction.
     * @memberof Building
     * @instance
     * @func ex_getReloadFrac
     * @return {number}
     * @lovecAttached
     */
     ...
     * @param {Entityc} e - Entity that deals damage.
     * @param {Healthc} e_t - Entity that receives damage.
     * @param {number} dmg
    ...
    const getDmgDeal = function(e, e_t, dmg, bDmgMtp) {
        return dmg
            * tryVal(tryProp(e.damageMultiplier, e), 1.0)
    ...
    /**
     * Returns warmup fraction.
     * @memberof Building
     * @instance
     * @func ex_getWarmupFrac
     * @return {number}
     * @lovecAttached
     */
    ...
    const getBuildShield = function(b, isSelfShield) {
        ...
        return readTypeValArr(DB_block.db["class"]["map"]["shield"], b.block, Function.airZero)(b, isSelfShield);
    };
     ...
     * @return {F4Array<UnitType, number, number, StatusEffect|null>} `ROW`: utp, amtUnit, shield, sta.
     */
