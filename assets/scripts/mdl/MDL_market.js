...
*/
    ...
    const addBit = function(team, amtTrans, isGlobal) {
        return amtTrans.fEqual(0.0) ?
            getBitAmt(team, isGlobal) :
            setBitAmt(team, getBitAmt(team, isGlobal) + amtTrans, isGlobal);
    }
    .setAnno("non-console");
