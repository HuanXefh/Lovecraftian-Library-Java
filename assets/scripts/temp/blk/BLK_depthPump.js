...
*/
  ...
  function comp_draw(b) {
    ...
    LCDraw.region(b.x, b.y, b.block.delegee.liqReg, 0.0, 1.0, MDL_color.getColor(b.dynaAttrRs), b.liquids.get(b.dynaAttrRs) / b.block.liquidCapacity);
  };
  ...
  module.exports = [
    ...
    .setMethod({
      ...
      ex_findDynaAttrTs: function(contArr, tx, ty, rot) {
        return LCPos.getTilesBlock(contArr, this, tx, ty);
      }
      .setProp({
        noSuper: true,
        override: true,
