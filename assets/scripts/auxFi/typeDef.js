...
*/
    ...
    /**
     * @global
     * @typedef {function(): void} C0Function
     */

    /**
     * @global
     * @template P
     * @typedef {function(P): void} CFunction<P>
     */
     ...
     * @template P1
     * @template P2
     * @typedef {function(P1, P2): void} C2Function<P1, P2>
     */
     ...
     * @template P2
     * @template P3
     * @typedef {function(P1, P2, P3): void} C3Function<P1, P2, P3>
     */
     ...
     * @template P3
     * @template P4
     * @typedef {function(P1, P2, P3, P4): void} C4Function<P1, P2, P3, P4>
     */

    /**
     * @global
     * @template R
     * @typedef {function(): R} F0Function<R>
     */
     ...
     * @template P
     * @template R
     * @typedef {function(P): R} FFunction<P, R>
     */
     ...
     * @template P2
     * @template R
     * @typedef {function(P1, P2): R} F2Function<P1, P2, R>
     */
     ...
     * @template P3
     * @template R
     * @typedef {function(P1, P2, P3): R} F3Function<P1, P2, P3, R>
     */
     ...
     * @template P4
     * @template R
     * @typedef {function(P1, P2, P3, P4): R} F4Function<P1, P2, P3, P4, R>
     */
    ...
    /**
     * Any Lovec class that extends {@link CLS_contentTemplate}.
     * @global
     * @typedef {LovecClass<CLS_contentTemplate>} ContentTemplate
     */
    ...
    /**
     * @global
     * @typedef {Function} TemplateParser
     * @param {Object} valOld
     * @return {Object} valNew
     */

    /**
     * @global
     * @typedef {Array} TemplateParserArray
     * @lovecRow `string` - nameProp
     * @lovecRow `TemplateParser` - tempParser
     */
     ...
     * @global
     * @typedef {[string, string]} DialogCharaTuple
     */
    ...
    /**
     * @global
     * @typedef {Array} DialogCharaParamArray
     * @lovecRow `number` - delay
     * @lovecRow `string` - nameMod
     * @lovecRow `string` - nameChara
     * @lovecRow `number|unset` - fracX
     * @lovecRow `boolean|Color|unset` - isDark0color
     * @lovecRow `string|unset` - anim
     * @lovecRow `Object|unset` - animParamObj
     * @lovecRow `Array|unset` - customActs
     */

    /**
     * @global
     * @typedef {Array} DialogSelectionData
     * @lovecRow `string` - nameMod
     * @lovecRow `string` - nameDial
     * @lovecRow `number` - selInd
     */

    /**
     * @global
     * @typedef {Array} DialogFlowData
     * @lovecRow `DialogTuple|unset` - dialTup
     * @lovecRow `DialogCharaTuple|unset` - charaTup
     * @lovecRow `Object|unset` - paramObj
     * @lovecRow `DialogCharaParamArray|unset` - charaParamArr
     */
    ...
    /**
     * @global
     * @typedef {Array} RecipeIo2Array
     * @lovecRow `ContentGn` - target
     * @lovecRow `number` - amt
     */

    /**
     * @global
     * @typedef {Array} RecipeIo3Array
     * @lovecRow `ContentGn` - target
     * @lovecRow `number` - amt
     * @lovecRow `number` - p
     */
    ...
    /**
     * @global
     * @typedef {Array} RecipeRawDataNumberArray
     * @lovecRow `string` - nameCt
     * @lovecRow `number` - num
     */
...
*/
    ...
    class Scl {};
    /** @global arc.scene.style.Style */
    class Style {};
    Button.ButtonStyle = class extends Style {};
