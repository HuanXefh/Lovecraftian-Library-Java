...
*/
    ...
    __extraContentData__ = {
        ...
        // Mod-specific
        /** @type {Object<string, Object<string, Stat>>} */
        stat: {},
        /** @type {Object<string, Object<string, StatUnit>>} */
        statUnit: {},
        ...
        shader: {},
        /** @type {Object<string, CacheLayer>} */
        cacheLayer: {},
        /** @type {Object<string, Units.Sortf>} */
        sortF: {},
        /** @type {Object<string, Dialog>} */
        dialog: {},
        /** @type {F2Array<string, DialogFlowData>} */
        dialogFlow: [],

        // Template
        /** @type {F2Array<string, F0Function<ContentTemplate>>} */
        weaponTemplate: [],
        /** @type {F2Array<string, F0Function<ContentTemplate>>} */
        bulletTemplate: [],
        /** @type {F2Array<string, F0Function<ContentTemplate>>} */
        ...
        // Getter
        /** @type {F2Array<string, FFunction<Object, Ability>>} */
        ability: [],
        /** @type {F2Array<string, FFunction<Object, AIController>>} */
        ai: [],
        /** @type {F2Array<string, FFunction<Object, ShootPattern>>} */
        shootPattern: [],
        /** @type {F2Array<string, FFunction<Object, DrawBlock>>} */
        drawer: [],
        /** @type {F2Array<string, FFunction<Object, Consume>>} */
        consumer: [],
     ...
     * @global
     * @param {UnitType} utp
     * @param {FFunction<Array<Weapon>, Array<Weapon>>} getter
     * @return {void}
     */
     ...
     * @global
     * @param {UnitType} utp
     * @param {FFunction<Array<Ability>, Array<Ability>>} getter
     * @return {void}
     */
     ...
     * @global
     * @param {UnitType} utp
     * @param {FFunction<Unit, AIController>} getter
     * @return {void}
     */
     ...
     * @global
     * @param {Block} blk
     * @param {FFunction<Array<DrawBlock>, Array<DrawBlock>>} getter
     * @return {void}
     */
     ...
     * @global
     * @param {Block} blk
     * @param {FFunction<Array<Consume>, Array<Consume>>} getter
     * @return {void}
     */
     ...
     * @return {Array<TextureRegion>|D2Array<TextureRegion>|D3Array<TextureRegion>}
     * @lovecTypeSensitive
     */
    ...
    /**
     * Used to load sound.
     * <br> It's also possible to safely use "SOUNDS: xxx" for `Sounds.xxx`.
     * @global
     * @param {SoundGn} se_gn
     * @param {boolean|unset} [returnUnset]
     * @return {Sound}
     * @lovecTypeSensitive
     */
    fetchSound = function(se_gn, returnUnset) {
        ...
        if(typeof se_gn !== "string") return returnUnset ? Sounds.unset : Sounds.none;

        let se = fetchSound.cacheMap.get(se_gn);
        if(se != null) return se;
        if(se_gn.startsWith("SOUNDS: ")) {
            try {
                se = Sounds[se_gn.replace("SOUNDS: ", "")];
            } catch(err) {
                console.err("[LOVEC] Sounds.${1} does not exist!".format(se_gn.replace("SOUNDS: ", "")));
                se = returnUnset ? Sounds.unset : Sounds.none;
            };
        } else {
            se = Vars.tree.loadSound(se_gn);
        };
        fetchSound.cacheMap.put(se_gn, se);

        return se;
    };
    /** @type {ObjectMap<string, Sound>} */
    fetchSound.cacheMap = new ObjectMap();
    ...
    fetchMusic = function(mus_gn) {
        if(mus_gn instanceof Music) return mus_gn;
        if(Vars.headless) return Musics.none;
        if(typeof mus_gn !== "string") return Musics.none;

        let mus = fetchMusic.cacheMap.get(mus_gn);
        if(mus != null) return mus;
        if(mus_gn.startsWith("MUSICS: ")) {
            try {
                mus = Musics[mus_gn.replace("MUSICS: ", "")];
            } catch(err) {
                console.err("[LOVEC] Musics.${1} does not exist!".format(mus_gn.replace("MUSICS: ", "")));
                mus = Musics.none;
            };
        } else {
            mus = Vars.tree.loadMusic(mus_gn);
        };
        fetchMusic.cacheMap.put(mus_gn, mus);

        return mus;
    };
    /** @type {ObjectMap<string, Music>} */
    fetchMusic.cacheMap = new ObjectMap();
    ...
    fetchSetting = function(name, useScl) {
        ...
        if(setting == null) throw new Error("Setting not found: " + name);
        ...
        switch(mode) {
            ...
            case 0 :
                return function(nameMod, name) {
                    ...
                    if(isNullable ? ct === undefined : ct == null) throw new LCError.FetchUnregisteredContentError(nameMod + "-" + name);
                    return ct;
                };
            ...
            case 1 :
                return function(name) {
                    ...
                    let ct = cont instanceof Array ?
                        ...
                        cont[name];
                    if(ct == null && def !== undefined) ct = def;
                    if(isNullable ? ct === undefined : ct == null) throw new LCError.FetchUnregisteredContentError(name);
                    return ct;
                };
            ...
            case 2 :
                return function(name, paramObj) {
                    ...
                    if(isNullable ? temp === undefined : temp == null) throw new Error("Cannot find content template: " + name);
            ...
            case 3 :
                ...
                return function(name, paramObj) {
                    ...
                    if(ct == null && !isNullable) throw new LCError.FetchUnregisteredContentError(name);
                    return ct;
                };
     ...
     * Returns null if the game fails to compile the shader.
     * @global
     * @param {string} name
     * @return {Shader|null}
     */
     ...
     * @param {string} categ
     * @param {C2Function<Unit, Tile|null>} scr - `ARGS`: unitPlayer, tMouse.
     * @return {void}
     */
    ...
    (function() {
        ...
        function throwDebugError() {
          if(Core.settings.getBool("lovec-test0error-shader", false)) throw new Error("Shader debug");
        };
         ...
         * @global
         * @param {string} name
         * @param {F0Function<Shader>} shaderF
         * @return {void}
         */
     ...
     * @return {void}
     */
    newShaderCacheLayer = __createNewXxx__(__extraContentData__.cacheLayer, 1, function(name, shader, cacheLayFallback) {
     ...
     * @global
     * @param {string} name
     * @param {F0Function<ContentTemplate>} tempF
     * @return {void}
     */
     ...
     * @global
     * @param {string} name
     * @param {FFunction<Object|unset, Ability>} getter
     * @return {void}
     */
     ...
     * @global
     * @param {string} name
     * @param {FFunction<Object|unset, ShootPattern>} getter
     * @return {void}
     */
     ...
     * @global
     * @param {string} name
     * @param {F3Function<Unit, number, number, number>} costF - `ARGS`: unit, x, y.
     * @return {void}
     */
     ...
     * @global
     * @param {string} name
     * @param {F3Function<Unit, number, number, number>} propF - `ARGS`: unit, x, y.
     * @return {void}
     */
     ...
     * @global
     * @param {string} name
     * @param {FFunction<Object|unset, DrawBlock>} getter
     * @return {void}
     */
     ...
     * @global
     * @param {string} name
     * @param {FFunction<Object|unset, Consume>} getter
     * @return {void}
     */
     ...
     * @global
     * @param {string} name
     * @param {F0Function<Dialog>} getter
     * @return {void}
     */
     ...
     * @global
     * @param {string} name
     * @param {DialogFlowData} dialFlowData - See {@link CLS_dialogFlowBuilder}.
     * @return {void}
     */
