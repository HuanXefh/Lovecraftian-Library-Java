...
*/
     ...
     * @param {Array} arr
     * @param {(function(Object): Object)|unset} [mapF]
     * @return {boolean}
     */
    ...
    Array.prototype.looseIncludes = function(arr) {
        let i = 0, iCap = this.iCap();
        while(i < iCap) {
            if(!(this[i] instanceof Array)) throw new TypeError(arr + " is not a 2D-array");
     ...
     * @param {Object} ele
     * @param {FFunction<Object, Object>|unset} [mapF]
     * @return {Object|null} Removed element.
     */
     ...
     * @param {FFunction<Object, Object>} mapF
     * @return {this}
     */
    ...
    .setProp({
        /**
         * @memberof Array.prototype.mixSort
         * @type {Array<string>}
         */
     ...
     * @param {number} ord
     * @param {Object|unset} [def] - Incomplete rows will be filled with `def`.
     * @return {Array} New array.
     */
    ...
    /**
     * `Array#flat`, which doesn't exist here.
     * @return {Array}
     */
     ...
     * @param {number|unset} [ord]
     * @param {number|unset} [off]
     * @return {F2Array<Object, number>} New array. <br> `ROW`: ele, count.
     */
